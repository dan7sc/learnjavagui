...
public class Group extends JFrame {
  ...
  public Group(String arquivoImagem) {
    ...
    hg.addGroup(gl.createParallelGroup().addComponent(lb1).addComponent(lb2).addComponent(lb3));
    gl.setHorizontalGroup(hg);

    // Make lines
    GroupLayout.SequentialGroup vg = gl.createSequentialGroup();
    vg.addGroup(gl.createParallelGroup().addComponent(lb1));
    vg.addGroup(gl.createParallelGroup().addComponent(lb2));
    vg.addGroup(gl.createParallelGroup().addComponent(lb3));
