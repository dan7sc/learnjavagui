...
public class Group extends JFrame {
  ...
  public Group(String arquivoImagem) {
    ...
    hg.addGroup(gl.createParallelGroup().addComponent(lb1).addComponent(lb4).addComponent(lb7));
    hg.addGroup(gl.createParallelGroup().addComponent(lb2).addComponent(lb5).addComponent(lb8));
    hg.addGroup(gl.createParallelGroup().addComponent(lb3).addComponent(lb6).addComponent(lb9));
    ...
    vg.addGroup(gl.createParallelGroup().addComponent(lb4).addComponent(lb5).addComponent(lb6));
    vg.addGroup(gl.createParallelGroup().addComponent(lb7).addComponent(lb8).addComponent(lb9));
